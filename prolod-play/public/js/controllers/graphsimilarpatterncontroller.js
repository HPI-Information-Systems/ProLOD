...
define(['angular', './controllers', 'dimple'], function (angular) {
    ...
    angular.module('Prolod2.controllers').controller("GraphSimilarPatternCtrl", ['$scope', '$routeParams', '$timeout', 'routeBuilder', 'httpApi', 'colorHash','$modal',
        function ($scope, $routeParams, $timeout, routeBuilder, httpApi, colorHash, $modal) {
            ...
            httpApi.getGraphSimilarPattern($routeParams.dataset, $routeParams.group, pattern).then(function (data) {
                ...
                var breadCrumbMenu = [
                    ...
                    {name: 'Similar Pattern ' + isoGroup, url: routeBuilder.getSimilarGraphPatterns()}
                ];
                /*
