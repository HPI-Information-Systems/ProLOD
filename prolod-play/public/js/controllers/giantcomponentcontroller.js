...
define(['angular', './controllers', 'dimple'], function (angular) {
    ...
    angular.module('Prolod2.controllers').controller("GiantComponentCtrl", ['$scope', '$routeParams', '$timeout', 'routeBuilder', 'httpApi', 'colorHash','$modal',
        function ($scope, $routeParams, $timeout, routeBuilder, httpApi, colorHash, $modal) {
            ...
            $scope.colorFunction = function (d) {
                //console.log(d);
                if (d.surrounding) {
                    //console.log(colorHash(d.group));
                    return colorHash("surrounding");
                }
