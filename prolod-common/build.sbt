...
libraryDependencies ++= Seq(
  ...
  ,"keyness" % "keyness" % "0.1-SNAPSHOT" exclude("org.slf4j", "slf4j-log4j12") exclude("commons-logging", "commons-logging")
  ,"graphlod" % "graphlod" % "0.1-SNAPSHOT" exclude("org.slf4j", "slf4j-log4j12") exclude("commons-logging", "commons-logging")
