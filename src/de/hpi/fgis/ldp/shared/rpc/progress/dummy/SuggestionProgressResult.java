 ...
 * 
 */
public class SuggestionProgressResult extends ProgressResult<SuggestionSetModel> {

  /**
	 * 
	 */
  private static final long serialVersionUID = 9033048976098520336L;

  protected SuggestionProgressResult() {
