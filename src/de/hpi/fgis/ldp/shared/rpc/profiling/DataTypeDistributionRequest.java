...
public class DataTypeDistributionRequest extends AbstractPredicateRequest implements
    CachableAction<DataTableResult> {
  private static final long serialVersionUID = -6193392213726397600L;

  protected DataTypeDistributionRequest() {
    // hide default constructor
  }

  public DataTypeDistributionRequest(final Cluster cluster, final ArrayList<Predicate> predicates) {
