 ...
 * {@link Integer} elements (e.g. for client - server communication)
 * 
 * @author toni.gruetze
 * 
 */
public class IntegerColumn extends DataColumn<Integer> {
  private static final long serialVersionUID = 3761866280179114974L;
