 ...
 * 
 */
public interface IUniquenessLoader {
   ...
   * @return the uniqueness and density in the given cluster
   */
  // FIXME move to model
  public abstract SortedSet<UniquenessModel> getUniqueness(final Cluster cluster,
