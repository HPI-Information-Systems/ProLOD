...
public class Bz2FileReaderTest {
  private NTFileParserTest ntFileTest;

  @Before
  public void setUp() {
    ntFileTest = new NTFileParserTest();
    final InputStream resStream = Bz2FileReaderTest.class.getResourceAsStream("./test.data.bz2");

    ntFileTest.parser =
        new Bz2FileReaderFactory() {}.setUnzippedReader(new NTFileParser.Factory() {}).build(
